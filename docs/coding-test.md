...
- [알고리즘](#algo)
  ...
  - [4. 힙](#4-힙)
    - [문제. 스코빌 섞기](#문제-스코빌-섞기)
  - [5. 정렬](#5-정렬)
    - [문제. 잘라서 K번째](#문제-잘라서-k번째)
  - [6. 완전탐색](#6-완전탐색)
    - [문제. 숫자 조각으로 소수](#문제-숫자-조각으로-소수)
  - [7. 탐욕법](#7-탐욕법)
    - [문제. 구명보트](#문제-구명보트)
  - [8. 동적계획법](#8-동적계획법)
    - [문제. 숫자 삼각형](#문제-숫자-삼각형)
  ...
  - [10. 이분탐색](#10-이분탐색)
    - [문제. 심사 대기](#문제-심사-대기)
  - [11. 그래프](#11-그래프)
    - [문제. 가장 먼 정점](#문제-가장-먼-정점)
  - [12. 구현](#12-구현)
    - [문제. 시계 방향 90도](#문제-시계-방향-90도)
  - [13. 문자열](#13-문자열)
    - [문제. 연속 압축](#문제-연속-압축)
  - [14. 투 포인터 · 슬라이딩 윈도우](#14-투-포인터-슬라이딩-윈도우)
    - [문제 A. 합이 target인 쌍](#문제-a-합이-target인-쌍)
    - [문제 B. 길이 k 최대 합](#문제-b-길이-k-최대-합)
- [SQL](#sql)
  - [15. SELECT · WHERE](#15-select-where)
    - [문제. 고액 연봉자](#문제-고액-연봉자)
  - [16. 집계 · GROUP BY](#16-집계-group-by)
    - [문제. 부서별 평균 연봉](#문제-부서별-평균-연봉)
  - [17. JOIN](#17-join)
    - [문제. 직원과 부서명](#문제-직원과-부서명)
    - [문제. 한 번도 주문하지 않은 회원](#문제-한-번도-주문하지-않은-회원)
  - [18. 문자열 · 날짜](#18-문자열-날짜)
    - [문제. 2024년 가입자](#문제-2024년-가입자)
    - [문제. 이름에 'kim'이 들어간 직원 (대소문자 무시)](#문제-이름에-kim이-들어간-직원-대소문자-무시)
  - [19. 윈도우 함수](#19-윈도우-함수)
    - [문제. 부서 내 연봉 순위](#문제-부서-내-연봉-순위)
    - [문제. 회원별 최근 주문 1건](#문제-회원별-최근-주문-1건)
  - [20. 서브쿼리](#20-서브쿼리)
    - [문제. 전체 평균보다 연봉이 높은 직원](#문제-전체-평균보다-연봉이-높은-직원)
- [개념](#concept)
  - [21. 시간 복잡도](#21-시간-복잡도)
    - [문제. n=10만에서 O(n²)](#문제-n10만에서-on²)
    - [문제. 복잡도 빠른 순서](#문제-복잡도-빠른-순서)
  - [22. 자료구조](#22-자료구조)
    - [문제. 스택 vs 큐](#문제-스택-vs-큐)
    - [문제. 해시 충돌](#문제-해시-충돌)
    - [문제. 힙 복잡도](#문제-힙-복잡도)
  - [23. 운영체제](#23-운영체제)
    - [문제. 프로세스 vs 스레드](#문제-프로세스-vs-스레드)
    - [문제. 교착 상태 4조건](#문제-교착-상태-4조건)
    - [문제. 컨텍스트 스위칭](#문제-컨텍스트-스위칭)
  - [24. 네트워크](#24-네트워크)
    - [문제. GET vs POST](#문제-get-vs-post)
    - [문제. TCP vs UDP](#문제-tcp-vs-udp)
    - [문제. HTTPS](#문제-https)
  - [25. 데이터베이스](#25-데이터베이스)
    - [문제. ACID](#문제-acid)
    - [문제. 인덱스](#문제-인덱스)
    - [문제. 정규화](#문제-정규화)
  - [26. 파이썬](#26-파이썬)
    - [문제. 2차원 배열 초기화](#문제-2차원-배열-초기화)
    - [문제. 리스트 vs 튜플](#문제-리스트-vs-튜플)
    - [문제. GIL](#문제-gil)
  - [27. 코딩테스트 전략](#27-코딩테스트-전략)
    - [문제. n 크기별 복잡도](#문제-n-크기별-복잡도)
    - [문제. BFS vs DFS](#문제-bfs-vs-dfs)
- [XGEN·에이전틱 AI 직무 코테](#xgen)
  - [28. 에이전트 파이프라인 DAG](#28-에이전트-파이프라인-dag)
    - [문제. 에이전트 실행 가능 여부](#문제-에이전트-실행-가능-여부)
  - [29. 프롬프트 LRU 캐시](#29-프롬프트-lru-캐시)
    - [문제. 용량 제한 캐시](#문제-용량-제한-캐시)
  - [30. LLM API 토큰 버킷](#30-llm-api-토큰-버킷)
    - [문제. 초당 최대 N회](#문제-초당-최대-n회)
  - [31. 하이브리드 모델 라우터](#31-하이브리드-모델-라우터)
    - [문제. 가장 싼 사용 가능 모델](#문제-가장-싼-사용-가능-모델)
  - [32. 실시간 예측 로그 윈도우](#32-실시간-예측-로그-윈도우)
    - [문제. 최근 k초 성공률](#문제-최근-k초-성공률)
  - [33. RAG 청크](#33-rag-청크)
    - [문제. 최대 길이 이하로 자르기](#문제-최대-길이-이하로-자르기)
  - [34. 추론 작업 대기열](#34-추론-작업-대기열)
    - [문제. 다음 잡을 고르기](#문제-다음-잡을-고르기)
  - [35. 모델 엔드포인트 최단 지연](#35-모델-엔드포인트-최단-지연)
    - [문제. 1번에서 n번까지](#문제-1번에서-n번까지)
  - [36. SQL — 모델별 토큰·지연](#36-sql-모델별-토큰-지연)
    - [문제. 모델별 호출 수, 평균 토큰, 성공률](#문제-모델별-호출-수-평균-토큰-성공률)
    - [문제. 모델별 지연 상위 5% 근처 (윈도우)](#문제-모델별-지연-상위-5-근처-윈도우)
  - [37. 개념 — 이 직무 면접/코테 서술](#37-개념-이-직무-면접코테-서술)
    - [문제. LangChain/LangGraph에서 노드와 엣지는 코딩테스트의 무엇과 같습니까?](#문제-langchainlanggraph에서-노드와-엣지는-코딩테스트의-무엇과-같습니까)
    - [문제. MLOps와 LLMOps의 차이를 세 줄로 쓰세요.](#문제-mlops와-llmops의-차이를-세-줄로-쓰세요)
    - [문제. 하이브리드 LLM 오케스트레이션에서 라우팅 기준 세 가지를 쓰세요.](#문제-하이브리드-llm-오케스트레이션에서-라우팅-기준-세-가지를-쓰세요)
    - [문제. 대용량 실시간 파이프라인에서 왜 슬라이딩 윈도우를 씁니까?](#문제-대용량-실시간-파이프라인에서-왜-슬라이딩-윈도우를-씁니까)
    - [문제. 오픈소스 프레임워크를 “재사용성 높게 추상화”한다는 것은 코테에서 어떻게 보입니까?](#문제-오픈소스-프레임워크를-재사용성-높게-추상화한다는-것은-코테에서-어떻게-보입니까)
...
| 키워드 | 바로가기 |
| --- | --- |
| 해시, Counter, 동명이인 | [출석 명단](#문제-출석-명단) |
| 괄호, 스택 | [괄호 검사](#문제-괄호-검사) |
| 큐, 배포 | [기능 배포](#문제-기능-배포) |
| 힙, 우선순위 | [스코빌 섞기](#문제-스코빌-섞기) |
| 정렬, K번째 | [잘라서 K번째](#문제-잘라서-k번째) |
| 순열, 소수, 완전탐색 | [숫자 조각으로 소수](#문제-숫자-조각으로-소수) |
| 그리디, 투 포인터 | [구명보트](#문제-구명보트) |
| DP | [숫자 삼각형](#문제-숫자-삼각형) |
| DFS/BFS | [타겟 만들기](#문제-타겟-만들기) |
| 이분탐색 | [심사 대기](#문제-심사-대기) |
| 그래프 BFS | [가장 먼 정점](#문제-가장-먼-정점) |
| 격자 회전 | [시계 방향 90도](#문제-시계-방향-90도) |
| 문자열 압축 | [연속 압축](#문제-연속-압축) |
| 투 포인터 | [합이 target인 쌍](#문제-a-합이-target인-쌍) |
| 슬라이딩 윈도우 | [길이 k 최대 합](#문제-b-길이-k-최대-합) |
| SQL SELECT | [고액 연봉자](#문제-고액-연봉자) |
| GROUP BY | [부서별 평균 연봉](#문제-부서별-평균-연봉) |
| JOIN | [직원과 부서명](#문제-직원과-부서명) |
| 윈도우 함수 | [부서 내 연봉 순위](#문제-부서-내-연봉-순위) |
| 복잡도 | [n=10만에서 O(n²)](#문제-n10만에서-on²) |
| OS | [프로세스 vs 스레드](#문제-프로세스-vs-스레드) |
| 네트워크 | [GET vs POST](#문제-get-vs-post) |
| DB | [ACID](#문제-acid) |
| 파이썬 함정 | [2차원 배열 초기화](#문제-2차원-배열-초기화) |
| 에이전트 DAG | [에이전트 실행 가능 여부](#문제-에이전트-실행-가능-여부) |
| LRU 캐시 | [용량 제한 캐시](#문제-용량-제한-캐시) |
| 레이트리밋 | [초당 최대 N회](#문제-초당-최대-n회) |
| 모델 라우팅 | [가장 싼 사용 가능 모델](#문제-가장-싼-사용-가능-모델) |
| 실시간 로그 | [최근 k초 성공률](#문제-최근-k초-성공률) |
| RAG 청크 | [최대 길이 이하로 자르기](#문제-최대-길이-이하로-자르기) |
| 작업 큐 | [다음 잡을 고르기](#문제-다음-잡을-고르기) |
| 다익스트라 | [1번에서 n번까지](#문제-1번에서-n번까지) |
| LLMOps 개념 | [MLOps와 LLMOps](#문제-mlops와-llmops의-차이를-세-줄로-쓰세요) |
...
<a id="14-투-포인터-슬라이딩-윈도우"></a>
## 14. 투 포인터 · 슬라이딩 윈도우

**유형:** 투 포인터 / 고정 윈도우  
**판별:** 정렬된 두 수의 합, 또는 길이 k 구간 합.

<a id="문제-a-합이-target인-쌍"></a>
### 문제 A. 합이 target인 쌍
...
<a id="문제-이름에-kim이-들어간-직원-대소문자-무시"></a>
...
<a id="28-에이전트-파이프라인-dag"></a>
## 28. 에이전트 파이프라인 DAG

**유형:** 그래프 / 위상정렬  
**직무:** XGEN 코어 엔진이 에이전트 노드를 순환 없이 실행하는지.

<a id="문제-에이전트-실행-가능-여부"></a>
### 문제. 에이전트 실행 가능 여부
...
<a id="31-하이브리드-모델-라우터"></a>
## 31. 하이브리드 모델 라우터

**유형:** 힙  
**직무:** 여러 Open-Source/API 모델 중 지연·비용이 낮은 쪽을 고름.

<a id="문제-가장-싼-사용-가능-모델"></a>
### 문제. 가장 싼 사용 가능 모델
...
<a id="37-개념-이-직무-면접코테-서술"></a>
## 37. 개념 — 이 직무 면접/코테 서술

**유형:** 개념 / LLMOps · 오케스트레이션

<a id="문제-langchainlanggraph에서-노드와-엣지는-코딩테스트의-무엇과-같습니까"></a>
...
<a id="문제-mlops와-llmops의-차이를-세-줄로-쓰세요"></a>
